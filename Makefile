...
build-image:
	docker buildx build --platform linux/amd64 \
			--tag registry.cn-hangzhou.aliyuncs.com/k8s-aa/redis_manger_front:$(VERSION) \
			-f ./build/Dockerfile \
			.

upload-image:
	docker push registry.cn-hangzhou.aliyuncs.com/k8s-aa/redis_manger_front:$(VERSION)
