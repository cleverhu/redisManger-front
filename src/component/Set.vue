  ...
  <el-container>
    <el-main style="background-color:#545c64">
      <div id="box">
        ...
        <div style="margin-top: 5px">
          ...
          <el-button type="primary"
                     @click="getCommonFunc(1)"
                     :disabled="!getCommon">查看合集
          </el-button>
    ...
    <el-button type="danger" @click="del(delId)">确 定</el-button>
        ...
        <el-dialog :title="key" :visible.sync="editDialog" :before-close="handleClose">
          <el-button style="margin-bottom: 10px;margin-top: -100px" icon="el-icon-document-add" type="primary"
          ...
          <div style="margin-top: 5px;margin-bottom: -20px">
            ...
            <div style="margin-top: 10px;">
              <span style="display:block;text-align:center">总共{{ pageObj.realTotal }}条</span>
            </div>

          </div>
        </el-dialog>

        <el-dialog title="添加Set" :visible.sync="addDialog">
...
export default {
  ...
  methods: {
    nextPage: function (search, flag, size) {
      ...
      this.axios.get(this.api.SetScan, {
    ...
    add: function (form) {
      ...
      this.axios.post(this.api.SetPost, JSON.stringify(form))
        .then(res => {
